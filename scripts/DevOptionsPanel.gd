...
const SECTION_ORDER_BY_TAB := {
	...
	TAB_BALLS_EVENTS: ["Ball Audio", "Table Events", "Cargo & Contraband", "Table Debris", "Anchor Testing / Visuals", "Treasure Testing / Visuals", "Powder Keg Presentation"],
	TAB_RUN_SYSTEMS: ["Long Sink Live Scoring", "Long Sink Score Presentation", "Back Room", "Kraken Boons", "Reserve Stack Tests", "Sunken Spoils", "Oath Testing"],
